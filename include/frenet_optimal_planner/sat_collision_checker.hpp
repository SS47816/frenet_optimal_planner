...
#ifndef SAT_COLLISION_CHECKER_HPP_
#define SAT_COLLISION_CHECKER_HPP_
...
private:
   ...
   * @return double 
   */
  inline double get_dot_product(geometry_msgs::Point32 point, geometry_msgs::Vector3 axis)
  {
   ...
   * @return false 
   */
  inline bool is_overlapping(std::vector<double> projection1, std::vector<double> projection2)
  {
...
#endif  // SAT_COLLISION_CHECKER_HPP_